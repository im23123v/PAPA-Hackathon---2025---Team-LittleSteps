  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-bold ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-95",
  {
    variants: {
      variant: {
        ...
        hero: "gradient-hero text-primary-foreground shadow-lg hover:shadow-glow hover:-translate-y-1 hover:scale-105",
        coin: "gradient-coin text-foreground shadow-coin hover:shadow-lg hover:-translate-y-1",
        success: "bg-success text-success-foreground shadow-md hover:bg-success/90 hover:-translate-y-0.5",
        "age-young": "bg-age-young text-primary-foreground shadow-md hover:bg-age-young/90 hover:-translate-y-0.5",
        "age-teen": "bg-age-teen text-primary-foreground shadow-md hover:bg-age-teen/90 hover:-translate-y-0.5",
      },
      size: {
